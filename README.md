...
**[Opp-School-Library]** is an application that holds school library information. The application enables the one to add a new student, a teacher or a book and also store information of whoever borrows a book and when.
...
```sh
  git clone git@github.com:HenaryKhuraijam/oop-school-library.git
```
...
Feel free to check the [issues page](git@github.com:HenaryKhuraijam/oop-school-library/issues).
